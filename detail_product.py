...
class DetailProduct:
    ...
    def load_ctkt_mua_sam_tab(self):
        ...
        max_height = self.max_row_heights.get("ctkt_mua_sam", 120)
        ...
        for ind in indicators:
            ...
            if is_parent(ind_code, all_codes):
                ...
                # GIẢI THÍCH SỬA: Nếu yeu_cau_str (indicator) rỗng, thì dùng ind_code thay thế để xây dựng tiêu chí đánh giá.
                if not yeu_cau_str:
                    yeu_cau_str = ind_code
        ...
        # Xử lý custom items dưới "Yêu cầu khác"
        custom_ids = set()
